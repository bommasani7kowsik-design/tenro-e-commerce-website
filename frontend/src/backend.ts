...
import type { AdminLoginStatus as _AdminLoginStatus, ExternalBlob as _ExternalBlob, Order as _Order, OrderItem as _OrderItem, OrderStatus as _OrderStatus, PaymentStatus as _PaymentStatus, Product as _Product, StripeSessionStatus as _StripeSessionStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addCartItem(arg0: ShoppingCartItem): Promise<void> {
        if (this.processError) {
            try {
    ...
    async authorizeAdmin(arg0: string, arg1: string): Promise<AdminLoginStatus> {
        if (this.processError) {
            try {
                const result = await this.actor.authorizeAdmin(arg0, arg1);
                return from_candid_AdminLoginStatus_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async clearFirstAdminStateAndDemoteAll(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearFirstAdminStateAndDemoteAll();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createOrder(arg0: Order): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createOrder(to_candid_Order_n12(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async createProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createProduct(await to_candid_Product_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCartItems(): Promise<Array<ShoppingCartItem>> {
        if (this.processError) {
            try {
    ...
    async removeCartItem(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: Product): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(await to_candid_Product_n18(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AdminLoginStatus_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AdminLoginStatus): AdminLoginStatus {
...
async function from_candid_Product_n38(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Product): Promise<Product> {
...
async function from_candid_opt_n37(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Product]): Promise<Product | null> {
    return value.length === 0 ? null : await from_candid_Product_n38(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n24(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        orderStatus: from_candid_OrderStatus_n27(_uploadFile, _downloadFile, value.orderStatus),
        user: record_opt_to_undefined(from_candid_opt_n29(_uploadFile, _downloadFile, value.user)),
...
function from_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "invalidSession" in value ? AdminLoginStatus.invalidSession : "invalidOtp" in value ? AdminLoginStatus.invalidOtp : "success" in value ? AdminLoginStatus.success : "invalidMobile" in value ? AdminLoginStatus.invalidMobile : "unauthorized" in value ? AdminLoginStatus.unauthorized : value;
}
...
async function from_candid_vec_n42(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_Product>): Promise<Array<Product>> {
    return await Promise.all(value.map(async (x)=>await from_candid_Product_n38(_uploadFile, _downloadFile, x)));
}
...
function to_candid_PaymentStatus_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaymentStatus): _PaymentStatus {
...
function to_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        total: value.total,
        paymentStatus: to_candid_PaymentStatus_n14(_uploadFile, _downloadFile, value.paymentStatus),
        orderStatus: to_candid_OrderStatus_n16(_uploadFile, _downloadFile, value.orderStatus),
...
function to_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: PaymentStatus): {
    pending: null;
} | {
    completed: null;
} | {
